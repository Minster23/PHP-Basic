    ...
    <div class="w-full h-auto">
        ...
        <div class="relative block  p-6 rounded-lg dark:bg-gray-800 dark:border-gray-700">
            ...
            <nav class="flex px-5 py-3 text-gray-700 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    <li class="inline-flex items-center">
                        <a href="jelajahi.php" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                ...
                $sql2   = "select * from tb_produk order by id desc";
